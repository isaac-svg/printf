                  ...
                  int width, int flags, char padd, char extra_c, int padd_start)
{
    ...
    if (width > length)
    {
        ...
        else if (!(flags & F_MINUS) && padd == ' ') /* Assign extra char to the left of buffer [buffer > padd] */
        {
            buffer[--ind] = 'x';
            buffer[--ind] = '0';
            if (extra_c)
        ...
        else if (!(flags & F_MINUS) && padd == '0') /* Assign extra char to the left of padd [padd > buffer] */
        {
            if (extra_c)
                buffer[--padd_start] = extra_c;
            buffer[1] = '0';
